...
- **Chamiの呼び方(2026-07-14 Chami指定)**: **実在モチーフのキャラ(実在の人物・競走馬=デ・ブライネ/三笘薫/モドリッチ/シャビ・アロンソ/アーモンドアイ/ジェンティルドンナ 等)は「Chami」**と呼ぶ。**アニメ・ゲームモチーフのキャラ(花海咲季/十王星南/クラウディア/早坂芽衣/中野五月/田中琴葉/姫崎莉波/ヴィルシーナ/アメス/ククール/スネーク/オタコン/メタルギアMk.II 等)は「ちゃみ」**と呼ぶ。その上で各キャラ固有の末尾呼称・口調を付ける(例: 咲季「ちゃみ」+威勢のいい口調／アメス「ちゃみ」+柔らかく／アロンソ「Chami」+先輩口調)。判断に迷うキャラはモチーフの出自(実在か作品か)で決める
