...
|---|---|---|---|---|
| KZ-006 | presented | インシデント記録Skill(記録漏れ防止・INC-83の抜けを塞ぐ) | 小/なし | Chami質問 2026-07-18「Skillで効率化」 |
| KZ-005 | presented | 投稿前チェックSkill(規約防衛=露出/2ch重複/煽り/2段リンク)★推奨 | 小/なし | 同上。規約防衛P0直結 |
| KZ-004 | presented | デプロイ反映Skill(?v=バンプ→commit→pull rebase→push→検証) | 小/なし | 同上。pull忘れ=INC-99温床の抜け防止 |
