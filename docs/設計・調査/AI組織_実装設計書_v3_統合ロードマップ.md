...
作成: 2026-07-11 ／ ステータス: **最終統合設計・構築フェーズ突入前の正本**
...
- 置き場: `docs/departments/00_common/current-priority.md`(数行・Stage 1で作成。変わったらここだけ更新)。**公開制約(v2§2.1: docs/はGitHub Pagesで公開)に準拠して書く**。事業目標・優先度を公開URLに載せることの可否はS1で一度Chamiに確認する
