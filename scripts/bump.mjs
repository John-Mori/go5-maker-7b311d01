 ...
 * 対象: アセット参照(?v=)を持つフロントHTML=index.html + 分割ページ(候補/提案/分析ランキング/ドラフト/投稿履歴)。
...
const TARGETS = ["index.html", "KouhoLists.html", "KouhoTeian.html", "analytics.html", "Stock.html", "StockLists.html"];
