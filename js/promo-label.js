  ...
  var TEMPLATES = {
    acc1: {
      ...
      price:    { src: 'assets/promo/tsukuyomi-price-base.png',
                  ...
                  // ★2026-08-18(3) 数字シート化後に数字を少し右へ(Chami『月詠みのこのロゴだけ数字をもう少し右に配置』
                  //   msg=1539134808440185044・AD研ルカ代行発注)。AD研実測=数字群の重心が中央基準『作品』より約5%左に寄る。
                  //   ただし¥プレフィックスが重心を左へ引く分を含む=右移動は控えめに。slot中心を0.508→0.528(x0.408→0.428・+2%≈778px基準+15px)。
                  //   ★シート版(digitSheet)描画で合わせている(フォント版との字幅差で狂わないよう順序=①シート化済②ここで右微調整)。実機で最終調整。
