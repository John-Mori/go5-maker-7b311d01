  ...
  var TEMPLATES = {
    acc1: {
      ...
      price:    { src: 'assets/promo/tsukuyomi-price-base.png',
                  // 数字だけ大きく・¥の高さへ真ん中揃え(Chami依頼2026-08-09)。旧 x0.440/y0.505/w0.233/h0.140 は
                  // 幅が狭く「10」が幅で縮小され小さく・中心も¥より上に浮いていた。基材の画素解析で ¥中心y≈0.588・
                  // 右内枠≈0.70・作品行≈0.647 を実測し、¥の右(0.415〜0.69)へ広げ中心を¥へ合わせた(桁は中央揃えのまま)。
                  slot: { x: 0.415, y: 0.513, w: 0.275, h: 0.150 } }
    },
    acc2: {
